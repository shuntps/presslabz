 ...
 * source at runtime: installing and activating a theme the way WordPress does
 * would require themes to ship compiled, which is a distribution format
 * question that belongs with the signed registry rather than here.
 *
